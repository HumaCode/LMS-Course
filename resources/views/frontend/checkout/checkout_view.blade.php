                        ...
                        <div class="card-body">
                            ...
                            <form method="post" class="row">
                                ...
                                <div class="input-box col-lg-12">
                                    ...
                                    <div class="form-group">
                                        <input id="phone" class="form-control form--control" type="number"
                                            name="phone" min="0" value="{{ Auth::user()->phone }}">
                            ...
                            <div class="payment-option-wrap">
                                ...
                                <div class="payment-tab is-active">
                                    ...
                                    <div class="payment-tab-toggle">
                                        <input checked id="handcash" name="cash_delivery" type="radio" value="handcash">
                                ...
                                <div class="payment-tab">
                                    <div class="payment-tab-toggle">
                                        ...
                                        <img class="payment-logo stripe" src="{{ asset('frontend') }}/images/logostripe.png"
                                            alt="">
                                    </div>
