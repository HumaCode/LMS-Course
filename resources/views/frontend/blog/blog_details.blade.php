                        ...
                        <div class="media media-card">
                            <div class="media-img rounded-full avatar-lg mr-4">
                                <img src="{{ asset('frontend') }}/images/img-loading.png"
                                    data-src="{{ asset('frontend') }}/images/small-avatar-1.jpg" alt="Avatar image"
                    ...
                    <div class="comments-wrap pt-5" id="comments">
                        ...
                        <div class="comment-list">
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <div class="media-img mr-4 rounded-full">
                                    <img class="rounded-full lazy" src="{{ asset('frontend') }}/images/img-loading.png"
                                        data-src="{{ asset('frontend') }}/images/small-avatar-1.jpg" alt="User image">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4 review-reply">
                                <div class="media-img mr-4 rounded-full">
                                    <img class="rounded-full lazy" src="{{ asset('frontend') }}/images/img-loading.png"
                                        data-src="{{ asset('frontend') }}/images/small-avatar-2.jpg" alt="User image">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <div class="media-img mr-4 rounded-full">
                                    <img class="rounded-full lazy" src="{{ asset('frontend') }}/images/img-loading.png"
                                        data-src="{{ asset('frontend') }}/images/small-avatar-3.jpg" alt="User image">
                                </div>
                                <div class="media-body">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="generic-list-item">
                                    ...
                                    @foreach ($bcategory as $cat)
                                        <li>
                                            <a
                                                href="{{ url('blog/cat/list/' . $cat->category_slug) }}">{{ $cat->category_name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
