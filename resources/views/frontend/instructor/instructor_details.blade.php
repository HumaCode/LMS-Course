        ...
        <div class="bg-gray py-5">
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-md-3">
                        <a href="admission.html" class="btn theme-btn text-center d-block"><i
                                class="la la-user-plus mr-1"></i>
                            Admission</a>
                    </div>
                </div>

                <ul class="nav nav-tabs generic-tab justify-content-center mt-3" id="myTab" role="tablist">
                    <li class="nav-item">
