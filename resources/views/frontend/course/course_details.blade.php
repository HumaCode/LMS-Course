                        ...
                        <div class="course-overview-card bg-gray p-4 rounded">
                            ...
                            <ul class="generic-list-item overview-list-item">
                                ...
                                @foreach ($goals as $goal)
                                    <li>
                                        <i class="la la-check mr-1 text-black"></i> {{ $goal->goal_name }}
                                    </li>
                                @endforeach
                            ...
                            <div class="card-body">
                                ...
                                <div class="preview-course-feature-content pt-40px">
                                    ...
                                    <div class="buy-course-btn-box">
                                        <button type="submit" class="btn theme-btn  w-100 flex-grow-1 mr-3 mb-2"
                                        ...
                                        <button type="submit" class="btn theme-btn w-100 theme-btn-white mb-2"
                        ...
                        <div class="card card-item">
                            <div class="card-image">
                                ...
                                <div class="course-badge-labels">
                                    ...
                                    @if ($instructorCourse->bestseller == 1)
                                        <div class="course-badge">Bestseller</div>
                                    @else
                                    @endif
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="card-title"><a
                                        href="{{ url('course/details/' . $instructorCourse->id . '/' . $instructorCourse->course_name_slug) }}">{{ $instructorCourse->course_name }}</a>
                                </h5>
                                <p class="card-text"><a
                                        href="teacher-detail.html">{{ $instructorCourse->user->name }}</a></p>
                                <div class="rating-wrap d-flex align-items-center py-2">
                                    <div class="review-stars">
                                        <span class="rating-number">4.4</span>
                                        <span class="la la-star"></span>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @else
                                        <p class="card-price text-black font-weight-bold">$
                                            {{ $instructorCourse->discount_price }} <span
                                                class="before-price font-weight-medium">$
                                                {{ $instructorCourse->selling_price }}</span>
                                        </p>
                                    @endif
...
@push('script')
    ...
    <script>
        ...
        // Menanggapi peristiwa penutupan modal
        $('#previewModal').on('hidden.bs.modal', function() {
            // Hentikan pemutaran video ketika modal ditutup
            player.stop();
        });
    </script>
@endpush
