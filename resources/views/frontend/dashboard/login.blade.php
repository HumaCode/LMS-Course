                        ...
                        <div class="card-body">
                            ...
                            <form method="post" class="pt-4">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="input-box">
                                        <label class="label-text">Name or Email or Username </label>
                                        <div class="form-group">
                                            <input
                                                class="form-control form--control @error('login')
                                                is-invalid
                                            @enderror"
                                                type="text" name="login" placeholder="Name or Email or Username"
                                                value="{{ old('login') }}">
                                    ...
                                    <div class="input-box">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input
                                                class="form-control form--control password-field @error('password')
                                            is-invalid
                                        @enderror"
