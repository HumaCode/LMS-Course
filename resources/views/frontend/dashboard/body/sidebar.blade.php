<div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
    ...
    <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
        ...
        <li>
            <a href="dashboard-profile.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
        ...
        <li>
            <a href="dashboard-bookmark.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                    viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none" />
        ...
        <li>
            <a href="index.html"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px"
                    viewBox="0 0 24 24" width="18px">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
        ...
        <li>
            <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal"><svg class="mr-2"
