    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            @foreach ($categories as $category)
                <li class="nav-item">
                    <a class="nav-link" id="{{ $category->category_slug }}-tab" data-toggle="tab"
                        href="#{{ $category->category_slug }}" role="tab"
    ...
    <div class="card-content-wrapper bg-gray pt-50px pb-120px">
        <div class="container">
            <div class="tab-content" id="myTabContent">
                ...
                @foreach ($categories as $category)
                    <div class="tab-pane fade" id="{{ $category->category_slug }}" role="tabpanel"
                        aria-labelledby="{{ $category->category_slug }}-tab">
                        <div class="row">

                            @php
                                $catwiseCourse = App\Models\Course::with('user')
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center pb-1">
                        ...
                        <p class="text-success fs-14 font-weight-medium">Updated<span
                                class="font-weight-bold pl-1">{{ $item->updated_at->format('M d Y') }}</span></p>
                    </div>
                    <ul
