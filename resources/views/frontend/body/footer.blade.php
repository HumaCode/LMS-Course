            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                    ...
                    <ul class="social-icons social-icons-styled">
                        <li class="mr-1"><a href="{{ $setting->facebook }}" target="_blank" class="facebook-bg"><i
                                    class="la la-facebook"></i></a></li>
                        <li class="mr-1"><a href="{{ $setting->twitter }}" target="_blank" class="twitter-bg"><i
    ...
    <div class="copyright-content py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <p class="copy-desc">&copy; {{ $setting->copyright }}</a></p>
                </div><!-- end col-lg-6 -->
                <div class="col-lg-6">
