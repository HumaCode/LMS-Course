    ...
    <table width="100%">
        ...
        <tbody>
            ...
            @foreach ($orderItem as $item)
                <tr class="font">
                    <td align="center">
                        <img src="{{ public_path($item->course->course_image) }}" height="50px;" width="70px;"
                            alt="">
                    </td>
        ...
        <tr>
            <td align="right">
                @if ($payment->coupon_discount != 0 && $payment->coupon_name != '-' && $payment->discount_amount != 0)
                    <h2><span style="color: green;">Coupon Discount:</span> {{ $payment->coupon_discount }}%</h2>
                    <h2><span style="color: green;">Discount Amount:</span> ${{ $payment->discount_amount }}</h2>
                @endif
