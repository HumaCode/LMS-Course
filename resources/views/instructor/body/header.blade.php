                    ...
                    <li class="nav-item dropdown dropdown-large">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            @php
                                ...
                                // Memisahkan nama pertama dan terakhir
                                $names = explode(' ', $name);

                                // Mengambil huruf pertama dari masing-masing nama
                                $initials = '';
                                foreach ($names as $n) {
                            ...
                            <div class="header-notifications-list">
                                ...
                                @forelse ($user->notifications as $notification)
                                    @php
                                        // Memisahkan nama pertama dan terakhir
                                        $names = explode(' ', $notification->data['name']);
                                    ...
                                    <a class="dropdown-item" href="javascript:;"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="notify bg-light-danger text-danger">{{ $initials }}
                                            </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center"
                            href="{{ route('instructor.change.password') }}"><i
                                class="bx bx-user-circle fs-5"></i><span>Change
                                Password</span></a>
                    </li>
