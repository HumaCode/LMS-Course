                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" method="POST" action="{{ route('update.blog.post') }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control cst @error('post_slug') is-invalid @enderror"
                                        ...
                                        value="{{ old('post_title', $blog->post_slug) }}">
                                    @error('long_descp')
                                        <span class="text-danger mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="post_tag"
                                        ...
                                        value="{{ old('post_title', $blog->post_tag) }}">
                                    @error('post_tag')
                                        <span class="text-danger mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('long_descp') is-invalid @enderror" name="long_descp" id="myeditorinstance"
                                        rows="3" placeholder="Description">{{ $blog->long_descp }}</textarea>
                                    @error('long_descp')
                                        <span class="text-danger mt-2">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <img id="showImage" src="{{ url($blog->post_image) }}" alt="Post Image"
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" class="btn btn-primary px-4 tbl-custom"><i
                                            class="bx bx-save"></i>Edit Blog</button>
                                </div>
                            </div>
                        </form>
                    </div>
