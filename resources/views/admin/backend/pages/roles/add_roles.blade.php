            ...
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" method="POST" action="{{ route('admin.store.roles') }}" class="row g-3">
                            @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" id="name" placeholder="Role Name" autofocus>
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" class="btn btn-primary px-4 tbl-custom"><i
                                            class="bx bx-save"></i>Add Roles</button>
                                </div>
                            </div>
                        </form>
                    </div>
