...
@section('admin')
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.all.roles') }}" class="btn btn-danger tbl-custom"><i
            ...
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form id="myForm" method="POST" action="{{ route('admin.update.roles') }}" class="row g-3">
                            @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" id="name" placeholder="Role Name" value="{{ $role->name }}">
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="d-md-flex d-grid align-items-center gap-3">
                                    <button type="submit" class="btn btn-primary px-4 tbl-custom"><i
                                            class="bx bx-save"></i>Update Roles</button>
                                </div>
                            </div>
                        </form>
                    </div>
